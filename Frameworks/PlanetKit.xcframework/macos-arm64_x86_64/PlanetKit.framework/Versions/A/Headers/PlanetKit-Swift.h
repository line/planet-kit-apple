...
typedef SWIFT_ENUM(NSInteger, PlanetKitAudioSampleType, closed) {
  PlanetKitAudioSampleTypeFloat = 0,
  PlanetKitAudioSampleTypeShort = 1,
};
...
@property (nonatomic, readonly, copy) NSArray<PlanetKitScreenCaptureDisplay *> * _Nonnull displayes;
...
/// If the last window image is captured successfully from <code>capture()</code>, the captured window rectangle will be set at <code>capturedBounds</code>.
...
/// Gets a bundle object associated with a window’s bundle ID.
@property (nonatomic, readonly, strong) NSBundle * _Nullable bundle;
/// If the target application window has multiple windows and the whole windows or a specific window need to be captured, set <code>hasMultipleWindows</code> to <code>true</code>.
/// remark:
///
/// The default value is <code>false</code>.
