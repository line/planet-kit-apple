...
@property (nonatomic, readonly, copy) NSArray<PlanetKitAudioDevice *> * _Nullable devices;
/// Gets or sets the microphone device.
/// remark:
///
/// The value can be changed at any time and will take effect at the next successful <code>PlanetKitAudio.start()</code> call.
/// If <code>micDevice</code> is set to <code>nil</code>, the input device will be disabled.
/// If you want to restore the default device, call <code>PlanetKitAudio.setPreferredDefaultDevice(type:)</code>.
@property (nonatomic, strong) PlanetKitAudioDevice * _Nullable micDevice;
/// Gets or sets the speaker device.
/// remark:
///
/// The value can be changed at any time and will take effect at the next successful <code>PlanetKitAudio.start()</code> call.
/// If <code>spkDevice</code> is set to <code>nil</code>, the output device will be disabled.
/// If you want to restore the default device, call <code>PlanetKitAudio.setPreferredDefaultDevice(type:)</code>.
@property (nonatomic, strong) PlanetKitAudioDevice * _Nullable spkDevice;
...
/// remark:
///
/// This property is reflected identically to <code>PlanetKitAudio.shared.micDevice</code>.
@property (nonatomic, strong) PlanetKitAudioDevice * _Nullable micDevice;
/// Represents the currently used speaker device.
/// remark:
///
/// This property is reflected identically to <code>PlanetKitAudio.shared.spkDevice</code>.
@property (nonatomic, strong) PlanetKitAudioDevice * _Nullable spkDevice;
@end
...
enum PlanetKitUIOrientation : NSInteger;
...
@property (nonatomic) enum PlanetKitUIOrientation orientation;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end
